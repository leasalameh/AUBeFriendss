...
const String tWelcomeScreenImage =
    "lib/src/assets/images/welcome_screen_images/welcome_screen.png";

// -- Login & SignUp Images
const String tLoginScreenImage = "lib/src/assets/images/login/login_image.png";
const String tSignUpImage = "lib/src/assets/images/sign_up/signup_image.png";

// -- Forget Password Images
const String tForgetPasswordImage =
    "lib/src/assets/images/forget_password/reset_password.png";
const String tEnterOtpImage =
    "lib/src/assets/images/forget_password/enter_otp.png";

//--Profile image
const String tProfileImage =
    "lib/src/assets/images/profile_pic/profile_pic.png";
