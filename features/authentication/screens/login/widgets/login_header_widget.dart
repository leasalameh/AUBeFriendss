  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(tLoginTitle, style: Theme.of(context).textTheme.headline1?.copyWith(color: tAccentColor,),),
        Text(tLoginSubTitle, style: Theme.of(context).textTheme.bodyText1?.copyWith(color: tAccentColor,),),
      ],
    );
  }
}